...
export class UsersRemoteComponent implements AfterViewInit {
  ...
  readonly columns: Colonne[] = [{
    ...
    data: [
      ...
      { type: 'campoBoolean', colVisible: true, allowEditing: false, allowFiltering: true, search: false, dataField: 'disabled', colWidth: '95', colCaption: 'Disabilitato', edit: false, groupDataField: undefined, trueText: 'Sì', falseText: 'No' },
      { type: 'campoBoolean', colVisible: true, allowEditing: false, allowFiltering: true, search: false, dataField: 'emailVerified', colWidth: '110', colCaption: 'Verificata', edit: false, groupDataField: undefined, trueText: 'Sì', falseText: 'No' },
